...
function SPURLFilter(t) {
    function e(t) { return t.replace(/((^\w+:|^)\/\/)|(\/$)/g, "") }
    var o = this;
    o.config = { active: !1, conditions: [], url: e(window.location.href) }, o.config = jQ.extend(o.config, t), o.rules = function(t) {
        var o = { show: "", hide: "" };
    ...
    function e(e) { new Promise(function(e, o) { void 0 === t.jQuery || Boolean(!t.jQuery.fn.on) ? ResourceLoader.loadScript("//ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js", function() { t.jQ = t.jQuery }).then(function() { e() }) : (t.jQ = t.jQuery, e()) }).then(e) }
    ...
    function o() {
        var t = jQ(".sp-form-outer").length ? ".sp-form-outer" : ".form-outer",
            ...
            i = r(),
            a = function() { var t = !1; return jQ("[sp-show-options]").each(function() { var e = jQ(this).attr("sp-show-options") ? JSON.parse(decodeURIComponent(jQ(this).attr("sp-show-options"))) : {}; if ("undefined" !== e.utmEnable && !0 === e.utmEnable) return t = !0, !1 }), t };
        try { s = "//" + jQ(t).next("script").attr("src").split("/")[2] } catch (t) { s = "//login.sendpulse.com" }
        new Promise(function(t, r) { o.length > 0 && (e.push(ResourceLoader.loadCss("//cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.13/css/intlTelInput.css")), e.push(ResourceLoader.loadScript("//cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.13/js/intlTelInput.min.js")), e.push(ResourceLoader.loadScript("//cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.13/js/utils.min.js"))), a() && e.push(ResourceLoader.loadScript(s + "/apps/fc3/build/spsbuster-libs.js")), n.length > 0 && e.push(ResourceLoader.loadCss(s + "/apps/fc3/build/form-animations.css?1708945005535")), e.push(ResourceLoader.loadScript("//cdnjs.cloudflare.com/ajax/libs/mobile-detect/1.3.6/mobile-detect.min.js")), e.push(ResourceLoader.loadCss(s + "/apps/fc3/build/form-defaults.css?1708945005535")), Promise.all(e).then(function() { t() }, function(t) { console.error("Necessary scripts have not been loaded:", t) }) }).then(function() { for (var t = 0, e = i.length; t < e; t++) new SPForm(i[t]).run() })
    }
    ...
    var s = "";
    t.spFormBootstrap = function() { "undefined" != typeof Promise && -1 !== Promise.toString().indexOf("[native code]") ? e(o) : ResourceLoader.loadPromisePolyfill(function() { e(o) }) }, t.addEventListener("load", t.spFormBootstrap, !1)
}(window), ResourceLoader.loadScript = function(t, e, o) {
    return new Promise(function(r, s) {
        var n = document.createElement("script");
        void 0 === o && (o = !1), n.type = "text/javascript", n.async = !0, n.src = t + (o ? "?t=" + (new Date).getTime() : ""), document.getElementsByTagName("head")[0].appendChild(n), n.readyState ? n.onreadystatechange = function() { "loaded" !== n.readyState && "complete" !== n.readyState || (n.onreadystatechange = null, "function" == typeof e && e(), r()) } : n.onload = function() { "function" == typeof e && e(), r() }, n.onerror = function() { s(new Error("Loading fail! " + t)) }
    })
}, ResourceLoader.loadCss = function(t, e, o) {
    return new Promise(function(r, s) {
        var n = document.createElement("link");
        void 0 === o && (o = !1), n.rel = "stylesheet", n.media = "screen", n.href = t + (o ? "?t=" + (new Date).getTime() : ""), document.getElementsByTagName("head")[0].appendChild(n), n.readyState ? n.onreadystatechange = function() { "loaded" !== n.readyState && "complete" !== n.readyState || (n.onreadystatechange = null, "function" == typeof e && e(), r()) } : n.onload = function() { "function" == typeof e && e(), r() }, n.onerror = function() { s(new Error("Loading fail! " + t)) }
    })
    ...
    void 0 === e && (e = !1), r.type = "text/javascript", r.async = !1, r.src = o + (e ? "?t=" + (new Date).getTime() : ""), document.getElementsByTagName("head")[0].appendChild(r), r.readyState ? r.onreadystatechange = function() { "loaded" !== r.readyState && "complete" !== r.readyState || (r.onreadystatechange = null, "function" == typeof t && t()) } : r.onload = function() { "function" == typeof t && t() }, r.onerror = function() { throw new Error("Loading fail! " + o) }
};
...
SPForm.prototype.init = function() {
    ...
    return jQ.get(t.ipSrvURL, function() {}, "jsonp").always(function(r) { t.ipInfo = r, e = r && r.country_code ? r.country_code : "", o.length && (t.telInputInit = window.intlTelInput(o[0], { initialCountry: "auto", excludeCountries: ["ru"], separateDialCode: !0, geoIpLookup: function(t) { t(e) }, utilScript: "//cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.13/js/utils.min.js" })) }), t.$closeButton.on("click", function(e) { t.close(!0) }), t.previewMode || t.$thanksBlock.on("click", function(e) { t.close(!0) }), t.$submitButton.prop("disabled", !t.valid), jQ(t.inputsSelector).each(function(e, o) {
        var r = jQ(o);
        r.hideTip = function() { r.hasClass("sp-invalid") && (this.removeClass("sp-invalid"), this.next(".sp-tip").detach()) }, r.showTip = function(t) {
            var e = JSON.parse(decodeURIComponent(this.attr("sp-tips")));
            this.addClass("sp-invalid"), e.hasOwnProperty(t) && this.after(jQ("<div/>", { class: "sp-tip sp-invalid", html: e[t] }))
        }, r.on("focus", function() { t.hideAllTips() }), "sform[email]" === r.attr("name") && t.initEmailAutocomplete(r), t.inputs[o.name] = r
    }), t.$submitButton.off("click").on("click", function(e) { return t.submit(), !1 }), t.$form.on("submit", function() { return t.submit(), !1 }), t.previewMode && (t.$form.removeClass("sp-form-popup"), t.$form.removeClass("sp-form-fixed"), t.$formOuter.removeClass("sp-popup-outer"), t.$closeButton.remove(), t.$formOuter.hasClass("sp-force-hide") && setTimeout(function() { t.$formOuter.removeClass("sp-force-hide"), t.$formOuter.addClass("sp-show") }, 200)), "undefined" != typeof sbjs && "undefined" !== t.showOptions.utmEnable && !0 === t.showOptions.utmEnable && sbjs.init(), t
}, SPForm.prototype.run = function() { this.show() }, SPForm.prototype.hideAllTips = function() { var t = this; for (var e in t.inputs) t.inputs.hasOwnProperty(e) && t.inputs[e].hasOwnProperty("hideTip") && t.inputs[e].hideTip() }, SPForm.prototype.disableInputs = function() {
    var t = this;
    ...
    "embed" !== e.formType && (e.$formOuter.addClass("sp-hide"), t && !e.history.getSubmits().length && e.history.addReject((new Date).getTime()), e.statAgent.registerRefusing(), function() {
        var t = document.querySelector(".sp-form-outer"),
            o = new CustomEvent("spFormCloseEvent", { detail: { formId: e.id }, bubbles: !0 });
        t.dispatchEvent(o)
    }())
}, SPForm.prototype.show = function() {
    function t(t) { t = t || .2, t *= 1e3, setTimeout(function() { o.$formOuter.addClass("sp-showing"), setTimeout(function() { o.$formOuter.addClass("sp-show"), e() }, 200), setTimeout(function() { o.$formOuter.removeClass("sp-showing") }, 400) }, t) }

    function e() {
        var t = document.querySelector(".sp-form-outer"),
            e = new CustomEvent("spFormShowEvent", { detail: { formId: o.id }, bubbles: !0 });
        t.dispatchEvent(e)
    }
    var o = this;
    if (!(function() { if (o.showOptions.hideOnMobile && "embed" !== o.formType) { return new MobileDetect(window.navigator.userAgent).mobile() } return !1 }() || "embed" !== o.formType && function() {
            ...
            "popup" !== o.formType && "fixed" !== o.formType || n || !i || (! function() {
                switch (o.showOptions.condition) {
                    case "onEnter":
                        ...
                        break;
                    case "onScroll":
                        jQ(window).scroll(function() { 100 * (jQ(window).scrollTop() + jQ(window).height()) / jQ(document).height() >= o.showOptions.scrollTo && t() });
                        break;
                    case "onCursorLeave":
                        ...
                        break;
                    case "onClose":
                        jQ(window).on("unload", function(e) { e.preventDefault(), t() })
                }
    ...
    function e(e) { return !!jQ.trim(t.val()) && o.telInputInit.isValidNumber() }
    var o = this,
        r = t.attr("sp-type");
    ...
    function t(t) { return t.replace(/\s+/g, " ") }
    var e = this;
    if (!e.sent && (e.validateAll(), e.valid)) {
        ...
        e.$submitButton.addClass("btn-loading"), e.disableInputs(), e.putInstanceToRegistry(),
            ...
            function() { jQ.ajax({ url: e.submitURL + "?callback=?", dataType: "jsonp", data: e.preparedData, jsonpCallback: e.makeCallbackName("cbSubmit"), statusCode: function() { alert("This form cannot be submitted because the referrer is missing. Appeal to site admin please.") } }) }(),
            function() {
                var t = document.querySelector(".sp-form-outer"),
                    o = new CustomEvent("spFormSubmitEvent", { detail: { formId: e.id }, bubbles: !0 });
                t.dispatchEvent(o)
            }()
    }
}, SPForm.prototype.makeCallbackName = function(t) { return "SPFormRegistry['" + this.formHash + "']." + t }, SPForm.prototype.putInstanceToRegistry = function() {
    var t = this;
    ...
    var e = this,
        ...
        i = function() {
            ...
            o = jQ("<datalist />", { id: r }).insertAfter(t), t.attr("list", r)
        },
        a = function() { o.empty() },
        u = function(t, e) {
            var s, n = "";
        ...
        p = function(t) {
            function e() { var t = i.split("@"); if (void 0 !== t[1] || "" === t[1]) return t[0] }
            var o = jQ(this),
                i = o.val();
            if (r = [], -1 !== i.indexOf("@") && function() { return !e() || -1 === i.split("@")[1].indexOf(".") }()) {
                var p = i.split("@")[0];
                r = e() && i.split("@")[1].length ? s.concat(n) : s, u(p, o.val())
            } else a()
        },
        c = function() { t.on("keyup", p) };
    ! function() { i(), c() }()
}, SPHistory.prototype.raise = function() {
    var t = this;
    if (localStorage[t.formHash]) try { return JSON.parse(localStorage.getItem(t.formHash)) } catch (t) { console.error(t) }
    ...
    return !t.config.active || function() {
        var e = { show: !1, hide: !0 },
            o = 0;
        return jQ.each(t.rules, function(r, s) { s.length > 0 ? (t.rules[r] = new RegExp(s.slice(0, -1), "i"), e[r] = t.rules[r].test(t.config.url)) : o += 1 }), 2 === o && (e.show = !0), e.show + !e.hide
    }()
};